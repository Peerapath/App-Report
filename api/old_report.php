        ...
        try {
            ...
            foreach ($results as $row) {
                ...
                if (!empty($row['report_image_path']) && !in_array($row['report_image_path'], $reportings[$reportingId]['report_image_path'])) {
                    ...
                    $reportings[$reportingId]['report_image_path'][] = sprintf("http://26.21.85.254:8080/Reportig/api/image_api.php?id=%s", $row['report_image_path']);
                ...
                if (!empty($row['task_id'])) {
                    ...
                    if (!empty($row['task_image_path']) && !in_array($row['task_image_path'], $reportings[$reportingId]['tasks'][$taskId]['task_image_path'])) {
                        ...
                        $reportings[$reportingId]['tasks'][$taskId]['task_image_path'][] = sprintf("http://26.21.85.254:8080/Reportig/api/image_api.php?id=%s", $row['task_image_path']);
                    }
                }
            }
