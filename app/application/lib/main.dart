    ...
    return Drawer(
      child: ListView(
        children: [
          ...
          _buildDrawerItem(context, "แจ้งปัญหา", SplashForm()),
          _buildDrawerItem(context, "หน้าหลัก", SplashScreen()),
          _buildDrawerItem(context, "สำหรับหน่วยงาน", Splashloading()),
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => ReportDetailPage(reportId: report.reportId),
          ),
        );
      },
      child: Card(
